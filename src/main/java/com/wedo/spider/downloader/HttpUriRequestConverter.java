...
public class HttpUriRequestConverter {
	...
	private HttpUriRequest convertHttpUriRequest(Request request, Site site, Proxy proxy) {
		...
		if (site != null) {
			requestConfigBuilder.setConnectionRequestTimeout(site.getTimeOut()).setSocketTimeout(site.getTimeOut())
					.setConnectTimeout(site.getTimeOut()).setCookieSpec(CookieSpecs.STANDARD);
		}
