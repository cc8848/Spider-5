...
public class JedisUtil {
	...
	private final static JedisUtil redis = new JedisUtil();
	private final static Logger logger = Logger.getLogger(JedisUtil.class);
	private final static Properties properties = PropertiesUtil.getByDynamic(
			"/home/melody/hSpace/workSpace/workPro/DangDangBookSpider/src/main/resources/redisPool.properties");
	/**
	 * 缓存生存时间
	 */
	...
	public static void init() {
		...
		if (jedisPool == null) {
			...
			// config.setMaxActive();
			config.setMaxTotal(Integer.valueOf(properties.getProperty("max_total")));
			config.setMaxIdle(Integer.valueOf(properties.getProperty("max_idle")));
			config.setMaxWaitMillis(Long.valueOf(properties.getProperty("max_wait_millis")));
			config.setTestOnBorrow(Boolean.valueOf(properties.getProperty("test_on_borrow")));
			config.setTestOnReturn(Boolean.valueOf(properties.getProperty("test_on_return")));
			jedisPool = new JedisPool(config, properties.getProperty("redis_ip", properties.getProperty("redis_port")));
			;
		}
	}
